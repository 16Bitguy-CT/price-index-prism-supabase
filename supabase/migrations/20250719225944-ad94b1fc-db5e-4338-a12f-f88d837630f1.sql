...
-- First, let's create the admin_audit_log table
...
-- Now fix the duplicate foreign key constraints issue
-- Drop the old auto-generated foreign key constraints that are causing conflicts
ALTER TABLE public.user_profiles DROP CONSTRAINT IF EXISTS user_profiles_organization_id_fkey;
ALTER TABLE public.user_profiles DROP CONSTRAINT IF EXISTS user_profiles_market_id_fkey;

-- Add new named foreign key constraints to avoid conflicts
